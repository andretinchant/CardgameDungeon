...
public static partial class CardSetSeeder
{
    private static List<AllyCard> CreateAllies()
    {
        return new List<AllyCard>
        {
            ...
            // Stats: ATK 4(4) + HP 5(5) + INIT 2(3) + Treasure 1(1) = 13
            ...
            // Stats: ATK 4(4) + HP 4(4) + INIT 1(1.5) + Treasure 1(1) = 10.5
            ...
            // Stats: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 0(0) = 10.5
            // Effect budget: 14 - 10.5 = 3.5 (Uncommon 3-4 range)
            ...
            // Stats: ATK 2(2) + HP 3(3) + INIT 0(0) + Treasure 0(0) = 5
            ...
            // Stats: ATK 4(4) + HP 4(4) + INIT 0(0) + Treasure 1(1) = 9
            ...
            // Stats: ATK 2(2) + HP 3(3) + INIT 1(1.5) + Ambusher(2) + Treasure 1(1) = 9.5
            ...
            // Stats: ATK 2(2) + HP 2(2) + INIT 1(1.5) + Ambusher(2) + Treasure 0(0) = 7.5
            ...
            // Stats: ATK 3(3) + HP 3(3) + INIT 1(1.5) + Ambusher(2) + Treasure 1(1) = 10.5
            // Effect budget: 14 - 10.5 = 3.5 (Uncommon 3-4 range)
            ...
            // Stats: ATK 1(1) + HP 1(1) + INIT 1(1.5) + Ambusher(2) + Treasure 0(0) = 5.5
            ...
            // Stats: ATK 3(3) + HP 2(2) + INIT 1(1.5) + Ambusher(2) + Treasure 0(0) = 8.5
            ...
            // ATK 4(4) + HP 4(4) + INIT 2(3) + Treasure 1(1) = 12. Effect = 6 ✓
            ...
            // ATK 3(3) + HP 4(4) + INIT 2(3) + Treasure 0(0) = 10. Effect = 4 ✓
            ...
            // Stats: ATK 3(3) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 8.5
            // Effect budget: 10 - 8.5 = 1.5 (Common 0-2 range)
            ...
            // ATK 3(3) + HP 5(5) + INIT 2(3) + Treasure 1(1) = 12. Effect = 6 ✓
            ...
            // ATK 3(3) + HP 5(5) + INIT 1(1.5) + Treasure 1(1) = 10.5. Effect = 3.5 ✓
            ...
            // ATK 2(2) + HP 4(4) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect = 1.5 ✓
            ...
            // ATK 1(1) + HP 3(3) + INIT 0(0) + Treasure 1(1) = 5. Effect = 1 ✓
            ...
            // ATK 3(3) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect = 5.5 ✓
            ...
            // ATK 3(3) + HP 3(3) + INIT 2(3) + Treasure 1(1) = 10. Effect = 4 ✓
            ...
            // ATK 1(1) + HP 2(2) + INIT 1(1.5) + Ambusher(2) + Treasure 0(0) = 6.5. Effect = 3.5 ✓
            ...
            // ATK 3(3) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect = 1.5 ✓
            ...
            // ATK 5(5) + HP 5(5) + INIT 2(3) + Treasure 0(0) = 13. Effect = 5 ✓
            ...
            // ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 0(0) = 10.5. Effect = 3.5 ✓
            ...
            // ATK 2(2) + HP 6(6) + INIT 1(1.5) + Treasure 1(1) = 10.5. Effect = 3.5 ✓
            ...
            // ATK 2(2) + HP 3(3) + INIT 0(0) + Treasure 0(0) = 5. Effect = 1 ✓
            ...
            // ATK 3(3) + HP 4(4) + INIT 1(1.5) + Treasure 0(0) = 8.5. Effect = 1.5 ✓
            ...
            // ── UNIQUE ──
            // Budget 30 (Unique cost 6): ATK 5(5) + HP 7(7) + INIT 3(4.5) + Treasure 2(2) = 18.5. Effect = 8 ✓
