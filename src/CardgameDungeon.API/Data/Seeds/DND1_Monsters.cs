...
public static partial class CardSetSeeder
{
    private static List<MonsterCard> CreateMonsters()
    {
        return new List<MonsterCard>
        {
            ...
            // Budget 24: ATK 7(7) + HP 9(9) + INIT 2(3) + Treasure 0(0) = 19. Effect budget = 5... too low.
            // Budget 24: ATK 6(6) + HP 8(8) + INIT 1(1.5) + Treasure 1(1) = 16.5. Effect budget = 7.5 ✓
            new MonsterCard(
                ...
                initiative: 1,
                treasure: 1,
                effect: "Race: Dragon. At start of combat: deal 2 damage to all attacking allies. With Advantage: +3 ATK this round",
                race: Race.Dragon,
                effectTags: "ON_COMBAT_START|DAMAGE:2:ALL_ENEMIES\nWITH_ADVANTAGE|+ATK:3"),
            // Budget 24: ATK 6(6) + HP 8(8) + INIT 1(1.5) + Treasure 1(1) = 16.5. Effect = 7.5 ✓

            // Budget 21: ATK 4(4) + HP 7(7) + INIT 1(1.5) + Treasure 1(1) = 13.5. Effect budget = 7.5 ✓
            new MonsterCard(
            ...
            // Budget 21: ATK 4(4) + HP 7(7) + INIT 1(1.5) + Treasure 1(1) = 13.5. Effect = 7.5 ✓

            // =====================
            // RARE (8) — Budget: Cost 4=18, 5=21; Effect budget 5-6
            // =====================

            // Budget 21: ATK 5(5) + HP 7(7) + INIT 1(1.5) + Treasure 2(2) = 15.5. Effect budget = 5.5 ✓
            new MonsterCard(
            ...
            // Budget 21: ATK 5(5) + HP 7(7) + INIT 1(1.5) + Treasure 2(2) = 15.5. Effect = 5.5 ✓

            // Budget 21: ATK 4(4) + HP 7(7) + INIT 2(3) + Treasure 1(1) = 15. Effect budget = 6 ✓
            new MonsterCard(
            ...
            // Budget 21: ATK 4(4) + HP 7(7) + INIT 2(3) + Treasure 1(1) = 15. Effect = 6 ✓

            // Budget 18: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 2(2) = 12.5. Effect budget = 5.5 ✓
            new MonsterCard(
            ...
            // Budget 18: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 2(2) = 12.5. Effect = 5.5 ✓

            // Budget 21: ATK 5(5) + HP 6(6) + INIT 2(3) + Treasure 1(1) = 15. Effect budget = 6 ✓
            new MonsterCard(
            ...
            // Budget 21: ATK 5(5) + HP 6(6) + INIT 2(3) + Treasure 1(1) = 15. Effect = 6 ✓

            // Budget 21: ATK 6(6) + HP 7(7) + INIT 1(1.5) + Treasure 1(1) = 15.5. Effect budget = 5.5 ✓
            new MonsterCard(
            ...
            // Budget 21: ATK 6(6) + HP 7(7) + INIT 1(1.5) + Treasure 1(1) = 15.5. Effect = 5.5 ✓
            ...
            // Budget 21: ATK 6(6) + HP 8(8) + INIT 1(1.5) + Treasure 0(0) = 15.5. Effect budget = 5.5 ✓
            new MonsterCard(
            ...
            // Budget 21: ATK 6(6) + HP 8(8) + INIT 1(1.5) + Treasure 0(0) = 15.5. Effect = 5.5 ✓

            // Budget 18: ATK 5(5) + HP 6(6) + INIT 1(1.5) + Treasure 1(1) = 13.5. Effect budget = 4.5... round to 5 ✓
            new MonsterCard(
            ...
            // Budget 18: ATK 5(5) + HP 6(6) + INIT 1(1.5) + Treasure 1(1) = 13.5. Effect = 4.5 (conservative rare) ✓

            // =====================
            // UNCOMMON (20) — Budget: Cost 2=10, 3=14, 4=18; Effect budget 3-4
            // =====================

            // Budget 18: ATK 5(5) + HP 6(6) + INIT 1(1.5) + Treasure 2(2) = 14.5. Effect budget = 3.5 ✓
            new MonsterCard(
            ...
            // Budget 18: ATK 5(5) + HP 6(6) + INIT 1(1.5) + Treasure 2(2) = 14.5. Effect = 3.5 ✓

            // Budget 14: ATK 3(3) + HP 5(5) + INIT 1(1.5) + Treasure 1(1) = 10.5. Effect budget = 3.5 ✓
            new MonsterCard(
            ...
            // Budget 14: ATK 3(3) + HP 5(5) + INIT 1(1.5) + Treasure 1(1) = 10.5. Effect = 3.5 ✓

            // Budget 14: ATK 3(3) + HP 4(4) + INIT 1(1.5) + Treasure 2(2) = 10.5. Effect budget = 3.5 ✓
            new MonsterCard(
            ...
            // Budget 14: ATK 3(3) + HP 4(4) + INIT 1(1.5) + Treasure 2(2) = 10.5. Effect = 3.5 ✓

            // Budget 14: ATK 3(3) + HP 4(4) + INIT 2(3) + Treasure 1(1) = 11. Effect budget = 3 ✓
            new MonsterCard(
            ...
            // Budget 14: ATK 3(3) + HP 4(4) + INIT 2(3) + Treasure 1(1) = 11. Effect = 3 ✓

            // Budget 18: ATK 4(4) + HP 6(6) + INIT 1(1.5) + Treasure 2(2) = 13.5. Effect budget = 4.5 → 4 ✓
            new MonsterCard(
            ...
            // Budget 18: ATK 4(4) + HP 6(6) + INIT 1(1.5) + Treasure 2(2) = 13.5. Effect = 4.5 ✓
            ...
            // Budget 14: ATK 4(4) + HP 4(4) + INIT 1(1.5) + Treasure 1(1) = 10.5. Effect budget = 3.5 ✓
            new MonsterCard(
            ...
            // Budget 14: ATK 4(4) + HP 4(4) + INIT 1(1.5) + Treasure 1(1) = 10.5. Effect = 3.5 ✓
            ...
            // Budget 18: ATK 5(5) + HP 5(5) + INIT 1(1.5) + Treasure 2(2) = 13.5. Effect budget = 4.5 → 4 ✓
            new MonsterCard(
            ...
            // Budget 18: ATK 5(5) + HP 5(5) + INIT 1(1.5) + Treasure 2(2) = 13.5. Effect = 4.5 ✓
            ...
            // Budget 14: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 1(1) = 11.5. Effect budget = 2.5 → 3 ✓
            new MonsterCard(
            ...
            // Budget 14: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 1(1) = 11.5. Effect = 2.5 ✓

            // Budget 10: ATK 2(2) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 7.5. Effect budget = 2.5 → 3 ✓
            new MonsterCard(
            ...
            // Budget 10: ATK 2(2) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 7.5. Effect = 2.5 ✓

            // Budget 10: ATK 2(2) + HP 3(3) + INIT 2(3) + Treasure 1(1) = 9. Effect budget = 1 → pair with Ambusher for 3 ✓
            new MonsterCard(
                ...
                race: Race.Monstrosity,
                effectTags: "PASSIVE|AMBUSHER\nWITH_ADVANTAGE|+ATK:1"),
            // Budget 10: ATK 2(2) + HP 3(3) + INIT 2(3) + Treasure 1(1) = 9. Effect = 1 (Ambusher ~2pt implicit) ✓
            ...
            // Budget 14: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 0(0) = 10.5. Effect budget = 3.5 ✓
            new MonsterCard(
            ...
            // Budget 14: ATK 4(4) + HP 5(5) + INIT 1(1.5) + Treasure 0(0) = 10.5. Effect = 3.5 ✓
            ...
            // Budget 10: ATK 2(2) + HP 2(2) + INIT 1(1.5) + Treasure 2(2) = 7.5. Effect budget = 2.5 → 3 ✓
            new MonsterCard(
            ...
            // Budget 10: ATK 2(2) + HP 2(2) + INIT 1(1.5) + Treasure 2(2) = 7.5. Effect = 2.5 ✓

            // =====================
            // COMMON (30) — Budget: Cost 1=6, 2=10; Effect budget 0-2
            // =====================

            // Budget 6: ATK 2(2) + HP 2(2) + INIT 1(1.5) + Treasure 0(0) = 5.5. Effect budget = 0.5 → 1 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 2(2) + HP 2(2) + INIT 1(1.5) + Treasure 0(0) = 5.5. Effect = 0.5 ✓

            // Budget 10: ATK 3(3) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect budget = 1.5 ✓
            new MonsterCard(
            ...
            // Budget 10: ATK 3(3) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect = 1.5 ✓

            // Budget 6: ATK 2(2) + HP 2(2) + INIT 1(1.5) + Treasure 0(0) = 5.5. Effect budget = 0.5 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 1(1) + HP 3(3) + INIT 0(0) + Treasure 0(0) = 4. Effect budget = 2 ✓
            new MonsterCard(
                ...
                race: Race.Undead,
                effectTags: "ON_DEATH|RESTORE_SELF_TO_DECK"),
            // Budget 6: ATK 1(1) + HP 3(3) + INIT 0(0) + Treasure 0(0) = 4. Effect = 2 ✓

            // Budget 6: ATK 1(1) + HP 2(2) + INIT 1(1.5) + Treasure 0(0) = 4.5. Effect budget = 1.5 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 1(1) + HP 2(2) + INIT 1(1.5) + Treasure 0(0) = 4.5. Effect = 1.5 ✓
            ...
            // Budget 6: ATK 1(1) + HP 3(3) + INIT 1(1.5) + Treasure 0(0) = 5.5. Effect budget = 0.5 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 1(1) + HP 3(3) + INIT 1(1.5) + Treasure 0(0) = 5.5. Effect = 0.5 ✓
            ...
            // Budget 6: ATK 1(1) + HP 2(2) + INIT 1(1.5) + Treasure 1(1) = 5.5. Effect budget = 0.5 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 1(1) + HP 2(2) + INIT 1(1.5) + Treasure 1(1) = 5.5. Effect = 0.5 ✓

            // Budget 10: ATK 3(3) + HP 4(4) + INIT 1(1.5) + Treasure 0(0) = 8.5. Effect budget = 1.5 ✓
            new MonsterCard(
            ...
            // Budget 10: ATK 3(3) + HP 4(4) + INIT 1(1.5) + Treasure 0(0) = 8.5. Effect = 1.5 ✓
            ...
            // Budget 10: ATK 2(2) + HP 3(3) + INIT 2(3) + Treasure 1(1) = 9. Effect budget = 1 ✓
            new MonsterCard(
            ...
            // Budget 10: ATK 2(2) + HP 3(3) + INIT 2(3) + Treasure 1(1) = 9. Effect = 1 ✓
            ...
            // Budget 6: ATK 2(2) + HP 1(1) + INIT 1(1.5) + Treasure 0(0) = 4.5. Effect budget = 1.5 ✓
            new MonsterCard(
                ...
                race: Race.Monstrosity,
                effectTags: "ON_COMBAT_START|+ATK:2"),
            // Budget 6: ATK 2(2) + HP 1(1) + INIT 1(1.5) + Treasure 0(0) = 4.5. Effect = 1.5 ✓

            // Budget 6: ATK 1(1) + HP 2(2) + INIT 0(0) + Treasure 0(0) = 3. Effect budget = 3 → cap at 2 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 1(1) + HP 2(2) + INIT 0(0) + Treasure 0(0) = 3. Effect = 3 (strong for common, but stats are very weak) ✓
            ...
            // Budget 6: ATK 1(1) + HP 1(1) + INIT 1(1.5) + Treasure 0(0) = 3.5. Effect budget = 2.5 → 2 ✓
            new MonsterCard(
            ...
            // Budget 6: ATK 1(1) + HP 1(1) + INIT 1(1.5) + Treasure 0(0) = 3.5. Effect = 2.5 ✓

            // Budget 10: ATK 2(2) + HP 3(3) + INIT 1(1.5) + Treasure 1(1) = 7.5. Effect budget = 2.5 → 2 ✓
            new MonsterCard(
            ...
            // Budget 10: ATK 2(2) + HP 4(4) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect budget = 1.5 ✓
            new MonsterCard(
                ...
                race: Race.Elemental,
                effectTags: "ON_COMBAT_START|-INIT:1:ENEMY"),
            // Budget 10: ATK 2(2) + HP 4(4) + INIT 1(1.5) + Treasure 1(1) = 8.5. Effect = 1.5 ✓
            ...
            // Budget 6: ATK 2(2) + HP 1(1) + INIT 1(1.5) + Treasure 1(1) = 5.5. Effect budget = 0.5 ✓
            new MonsterCard(
                ...
                race: Race.Construct,
                effectTags: "WITH_ADVANTAGE|+ATK:1"),
            // Budget 6: ATK 2(2) + HP 1(1) + INIT 1(1.5) + Treasure 1(1) = 5.5. Effect = 0.5 ✓
        };
    }
}
