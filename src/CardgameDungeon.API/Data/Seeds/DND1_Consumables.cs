...
{
    // Consumable budget curve (single-use bonus over equipment):
    //   Cost: 1=4, 2=6, 3=8, 4=10, 5=12
    //   Rarity multiplier: Common ×1.0, Uncommon ×1.1, Rare ×1.25, Unique ×1.5
    //   Final budgets: Common C1=4, Uncommon C2=7, Rare C3=10 C4=13, Unique C5=18
    // Stat costs: ATK×1.5, HP×1.0, INIT×1.5, remainder = EffectPts
    ...
    private static List<EquipmentCard> CreateConsumables()
    {
        ...
        {
            // ═══════════════════════════════════════════════════════════════
            //  UNIQUE (2) — Cost 5, Budget 18
            // ═══════════════════════════════════════════════════════════════

            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect18 = 18 (modal choice is worth ~18)
            ...
            // Budget: ATK0×1.5 + HP4 + INIT0×1.5 + Effect14 = 18 (cannot-die effect ~13, self-damage -1 offset)
            ...
            // ═══════════════════════════════════════════════════════════════
            //  RARE (8) — Cost 3→Budget 10, Cost 4→Budget 13
            // ═══════════════════════════════════════════════════════════════

            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect11.5 = 13 (AoE split damage + Advantage bonus)
            ...
            // Budget: ATK2×1.5 + HP0 + INIT0×1.5 + Effect7 = 10
            new(new Guid("00000000-0000-0000-0007-000000000004"),
                "Potion of Giant Attack", Rarity.Rare, 3, 2, 0, 0, EquipmentSlot.Potion,
                "Target ally gains +2 ATK for this combat round",
                effectTags: "ON_ACTIVATE|+ATK:2:ALLY"),

            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect13 = 13 (recovery from discard ~13)
            ...
            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect11.5 = 13 (ignores Shield ~2, direct damage ~1)
            ...
            // Budget: ATK0×1.5 + HP3 + INIT0×1.5 + Effect7 = 10 (AoE heal ~7)
            ...
            // Budget: ATK0×1.5 + HP2 + INIT2×1.5 + Effect5 = 10
            ...
            // Budget: ATK0×1.5 + HP0 + INIT3×1.5 + Effect8.5 = 13 (guaranteed first-strike ~8.5)
            ...
            // Budget: ATK0×1.5 + HP3 + INIT0×1.5 + Effect7 = 10 (no-damage effect ~7)
            ...
            // ═══════════════════════════════════════════════════════════════
            //  UNCOMMON (20) — Cost 2, Budget 7
            // ═══════════════════════════════════════════════════════════════

            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect5.5 = 7
            ...
            // Budget: ATK0×1.5 + HP3 + INIT0×1.5 + Effect4 = 7
            ...
            // Budget: ATK0×1.5 + HP2 + INIT0×1.5 + Effect5 = 7 (temporary HP + defensive)
            new(new Guid("00000000-0000-0000-0007-000000000013"),
                "Scroll of Shield", Rarity.Uncommon, 2, 0, 2, 0, EquipmentSlot.Scroll,
                "Target ally gains +2 HP until end of round. Reveals the next trap in the dungeon",
                effectTags: "ON_ACTIVATE|+HP:2:ALLY|REVEAL_TRAP"),

            // Budget: ATK0×1.5 + HP0 + INIT2×1.5 + Effect4 = 7
            new(new Guid("00000000-0000-0000-0007-000000000014"),
                "Potion of Speed", Rarity.Uncommon, 2, 0, 0, 2, EquipmentSlot.Potion,
                "Target ally gains +2 INIT this round",
                effectTags: "ON_ACTIVATE|+INIT:2:ALLY"),

            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect5.5 = 7 (single target damage)
            new(new Guid("00000000-0000-0000-0007-000000000015"),
                "Alchemist Fire", Rarity.Uncommon, 2, 1, 0, 0, EquipmentSlot.Bomb,
                "Deal 1 damage to target enemy",
                effectTags: "ON_ACTIVATE|DAMAGE:1:ENEMY"),

            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect5.5 = 7 (type-restricted bonus ~1)
            ...
            // Budget: ATK0×1.5 + HP2 + INIT0×1.5 + Effect5 = 7 (heal + cleanse ~5)
            ...
            // Budget: ATK2×1.5 + HP0 + INIT0×1.5 + Effect4 = 7 (AoE ATK ~4)
            ...
            // Budget: ATK1×1.5 + HP0 + INIT2×1.5 + Effect2.5 = 7
            ...
            // Budget: ATK0×1.5 + HP2 + INIT1×1.5 + Effect3.5 = 7
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect7 = 7 (INIT reduction AoE ~7)
            ...
            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect5.5 = 7 (AoE damage ~5.5)
            ...
            // Budget: ATK1×1.5 + HP1 + INIT0×1.5 + Effect4.5 = 7
            ...
            // Budget: ATK0×1.5 + HP2 + INIT0×1.5 + Effect5 = 7 (AoE HP ~5)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect7 = 7 (negate ~7)
            ...
            // Budget: ATK2×1.5 + HP-1 + INIT0×1.5 + Effect5 = 7 (self-damage drawback)
            new(new Guid("00000000-0000-0000-0007-000000000026"),
                "Potion of Rage", Rarity.Uncommon, 2, 2, -1, 0, EquipmentSlot.Potion,
                "Target ally gains +2 ATK but loses 1 HP",
                effectTags: "ON_ACTIVATE|+ATK:2:ALLY|-HP:1:ALLY"),

            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect7 = 7 (permanent HP loss ~7)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT2×1.5 + Effect4 = 7 (AoE INIT ~4)
            ...
            // Budget: ATK0×1.5 + HP1 + INIT1×1.5 + Effect4.5 = 7 (race-restricted AoE ~4.5)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect7 = 7 (untargetable ~7)
            ...
            //  Stat costs: ATK×1.5, HP×1.0, INIT×1.5. All consumables must have effects.
            // ═══════════════════════════════════════════════════════════════

            // Budget: ATK0×1.5 + HP1 + INIT0×1.5 + Effect3 = 4
            ...
            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect2.5 = 4
            ...
            // Budget: ATK0×1.5 + HP0 + INIT1×1.5 + Effect2.5 = 4
            ...
            // Budget: ATK1×1.5 + HP0 + INIT0×1.5 + Effect2.5 = 4 (ignores Armor ~1)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (cleanse ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (reveal ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (enemy INIT reduction ~4)
            ...
            // Budget: ATK0×1.5 + HP1 + INIT0×1.5 + Effect3 = 4 (conditional heal ~3)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (enemy ATK reduction ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (type-restricted debuff ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (negate room effects ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (disable retarget ~4)
            ...
            // Budget: ATK1×1.5 + HP0 + INIT-1×1.5 + Effect4 = 4 (drawback offsets)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (exile prevention ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (opportunity attack immunity ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (field cleanse ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (Ambusher grant ~4)
            ...
            // Budget: ATK0×1.5 + HP0 + INIT0×1.5 + Effect4 = 4 (untargetable ~4)
