...
public static partial class CardSetSeeder
{
    private static List<DungeonRoomCard> CreateDungeonRooms()
    {
        return new List<DungeonRoomCard>
        {
            ...
            new DungeonRoomCard(new Guid("00000000-0000-0000-0005-000000000002"), "Rat-Infested Cellar", Rarity.Common, 1, null, null, 3, "Swarms of rats reduce the Attack of the weakest ally by 1 for this combat"),
            new DungeonRoomCard(new Guid("00000000-0000-0000-0005-000000000003"), "Abandoned Guardroom", Rarity.Common, 1, null, null, 4, "Rusted weapons line the walls; monsters in this room gain +1 Attack"),
            ...
            new DungeonRoomCard(new Guid("00000000-0000-0000-0005-000000000014"), "Cursed Chapel", Rarity.Common, 2, null, null, 7, "Dark prayers empower the undead; undead monsters gain +2 Attack"),
            ...
            new DungeonRoomCard(new Guid("00000000-0000-0000-0005-000000000016"), "Gladiator Arena", Rarity.Common, 2, null, null, 7, "The crowd demands blood; the ally with the highest Attack must attack first each round"),
            ...
            new DungeonRoomCard(new Guid("00000000-0000-0000-0005-000000000027"), "Tomb of the Fallen", Rarity.Common, 3, null, null, 7, "Spirits of fallen warriors haunt the tomb; all allies lose 1 Attack permanently"),
            ...
            new DungeonRoomCard(new Guid("00000000-0000-0000-0005-000000000034"), "Abyssal Rift", Rarity.Common, 4, null, null, 10, "Demonic energy seeps through; monsters gain +2 Attack and +2 HP"),
